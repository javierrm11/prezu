      ...
      <div className="flex flex-wrap gap-3 rounded-xl border border-borde bg-superficie p-4 shadow-tarjeta">
        ...
        <div className="w-full overflow-hidden sm:min-w-[130px] sm:w-auto sm:flex-1">
          ...
          <input
            ...
            className="h-11 w-[92%] min-w-0 overflow-hidden rounded-lg border border-borde bg-superficie px-3 text-sm text-texto focus:border-secundario focus:outline-none focus:ring-1 focus:ring-secundario"
          />
        </div>
        <div className="w-full overflow-hidden sm:min-w-[130px] sm:w-auto sm:flex-1">
